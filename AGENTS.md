...
| LPR port parameter set fix (Epson L1800) | 🧪 Pending Test | Fixed "Parameter set cannot be resolved using the specified named parameters" error in LPR mode by removing invalid `-LprHostAddress` parameter from `Add-PrinterPort`. |
